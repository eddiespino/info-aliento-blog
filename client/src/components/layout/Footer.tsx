      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          ...
          <div className="mb-6 sm:mb-0">
            ...
            <div className="flex space-x-4">
              <a href="https://x.com/ProyectoAliento" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
              ...
              <a href="https://github.com/eddiespino/info-aliento-blog" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
              ...
              <a href="https://discord.gg/G5DfSUJf9x" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
          ...
          <div>
            ...
            <ul className="grid grid-cols-2 sm:grid-cols-1 gap-x-4 gap-y-2">
              ...
              <li><a href="https://peakd.com/@aliento" target="_blank" rel="noopener noreferrer" className="text-sm sm:text-base text-muted-foreground hover:text-primary transition-colors">PeakD</a></li>
        ...
        <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-border text-center">
          <p className="text-xs sm:text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} Aliento Project. {t('footer.copyright')}
          </p>
        </div>
      </div>
    </footer>
